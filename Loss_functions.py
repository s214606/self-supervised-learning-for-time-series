...
class NTXentLoss(torch.nn.Module):
    ...
    def __init__(self, device, batch_size, temperature, use_cosine_similarity):
        ...
        self.mask_samples_from_same_representation = self.get_correlated_mask().type(torch.bool)
    ...
    def forward(self, zis, zjs):
        """Defines the forward function for computing the loss of a trained model.
        The parameters 'zis' and 'zjs' mean two different representations of the same data,
        for example, the frequency and time representations of data, or the original and augmented time representation."""
